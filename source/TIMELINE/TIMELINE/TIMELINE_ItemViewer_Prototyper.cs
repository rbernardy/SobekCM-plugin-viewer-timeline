...
namespace TIMELINE
{
    public class TIMELINE_ItemViewer_Prototyper : iItemViewerPrototyper
    {
        public string ViewerType { get; set; }
        public string ViewerCode { get; set; }
        public string[] FileExtensions { get; set; }

        /// <summary> Constructor for a new instance of the TIMELINE_ItemViewerPrototyper class </summary>
        public TIMELINE_ItemViewer_Prototyper()
        {
            ViewerType = "TIMELINE";
            ViewerCode = "timeline";
        }
        ...
        /// <summary> Creates and returns the an instance of the <see cref="TIMELINE_ItemViewer"/> class for showing a  
        /// timeline from a page within a digital resource during execution of a single HTTP request. </summary>
        /// <param name="CurrentItem"> Digital resource object </param>
        /// <param name="CurrentUser"> Current user, who may or may not be logged on </param>
        /// <param name="CurrentRequest"> Information about the current request </param>
        /// <param name="Tracer"> Trace object keeps a list of each method executed and important milestones in rendering </param>
        /// <returns> Fully built and initialized <see cref="TIMELINE_ItemViewer"/> object </returns>
        ...
        {
            return new TIMELINE_ItemViewer(CurrentItem, CurrentUser, CurrentRequest, Tracer);
        }
    }
}